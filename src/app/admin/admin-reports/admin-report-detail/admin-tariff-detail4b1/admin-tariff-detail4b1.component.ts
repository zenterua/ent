...
@Component({
  selector: 'app-admin-tariff-detail4b1',
  templateUrl: './admin-tariff-detail4b1.component.html',
  styleUrls: ['./admin-tariff-detail4b1.component.scss']
})
export class AdminTariffDetail4b1Component implements OnInit {
  socanFees:number = 0;
