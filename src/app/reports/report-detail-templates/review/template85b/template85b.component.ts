...
@Component({
	selector: 'app-template85b',
	templateUrl: './template85b.component.html',
  animations: [trigger('animationPopup', animationPopup)]
})
export class Template85bComponent implements OnInit, OnDestroy {
	socanFees: number = 0;
	...
	sendFees(save) {
		let calcObj = {
			...
			quarter: this.reportsArr[0].VALID_MONTH,
