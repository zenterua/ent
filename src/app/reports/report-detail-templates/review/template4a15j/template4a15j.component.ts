...
@Component({
	selector: 'app-template4a15j',
	templateUrl: './template4a15j.component.html',
  animations: [trigger('animationPopup', animationPopup)]
})
export class Template4a15jComponent implements OnInit, OnDestroy  {
	socanFees: number = 0;
	...
	sendFees(save) {
		let calcObj = {
			...
			isSave: save,
			withRecorded: this.numberOfResound,
